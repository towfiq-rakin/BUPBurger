...
import static org.rakin.bupburger.view.customer.CartPanel.TOTAL_FOODS_LABEL;
...
import static org.rakin.bupburger.view.customer.FoodDetails.FOOD_DETAILS_FRAME;
...
public class BrowseFoodsPanel extends JPanel {
    ...
    static List<Integer> selectedFoodId;
    ...
    private void addToCart(ActionEvent e) {
        try {
            ...
            System.out.println("Selected Food ID: " + selectedFood.getId());
            System.out.println("Selected Food ID: " + selectedFoodId.get(0));
