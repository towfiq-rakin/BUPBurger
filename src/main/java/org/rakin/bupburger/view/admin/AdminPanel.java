package org.rakin.bupburger.view.admin;

import javax.swing.border.*;

import org.rakin.bupburger.view.LoginPanel;
import org.rakin.bupburger.view.customer.ProjectDetails;
...
import static org.rakin.bupburger.App.mainFrame;
...
public class AdminPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        //======== panel ========
        {
            ...
            //======== subAdminPanel ========
            {
                subAdminPanel.setBackground(Color.black);
            ...
            manageUsersButton.setBorder(new LineBorder(new Color(0x21252b)));
            ...
            addUserButton.setBorder(new LineBorder(new Color(0x21252b)));
            ...
            addFoodsButton.setBorder(new LineBorder(new Color(0x21252b)));
                    ...
                    .addGroup(GroupLayout.Alignment.TRAILING, panelLayout.createSequentialGroup()
                        .addGroup(panelLayout.createParallelGroup()
                            ...
                            .addGroup(panelLayout.createSequentialGroup()
                                .addGap(25, 25, 25)
                                .addGroup(panelLayout.createParallelGroup()
                                    .addComponent(manageUsersButton, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label1, GroupLayout.PREFERRED_SIZE, 215, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(addUserButton, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(addFoodsButton, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(projectDetailsButton, GroupLayout.PREFERRED_SIZE, 224, GroupLayout.PREFERRED_SIZE))))
                        .addGap(28, 28, 28)
